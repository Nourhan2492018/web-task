...
class DemoApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const ItemsDemoPage(),
    );
  }
}

class ItemsDemoPage extends StatelessWidget {
  const ItemsDemoPage({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    final demoItem = ItemModel(
      ...
      description: 'Design system for the new application',
      imageUrl: 'https://picsum.photos/400/300?random=1',
      createdAt: DateTime.now(),
      category: 'Design',
      status: 'Pending Approval',
      dateRange: 'May 16 - May 20, 2025',
      assignedUsers: [
        'User 1',
        'User 2',
        'User 3',
    ...
    return Scaffold(
      ...
      appBar: AppBar(title: const Text('Items Dashboard')),
      body: Center(
        child: Padding(
          padding: const EdgeInsets.all(20.0),
          child: ConstrainedBox(
            constraints: const BoxConstraints(maxWidth: 350),
            child: FigmaItemCard(item: demoItem),
          ),
        ),
      ),
    );
