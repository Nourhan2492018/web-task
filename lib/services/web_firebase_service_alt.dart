...
class WebFirebaseService {
  ...
  Future<String?> addItem(Map<String, dynamic> item) async {
    try {
      ...
      final jsPromise = js_util.callMethod(html.window, 'addFirestoreItem', [
        jsItem,
      ]);
  ...
  Future<bool> updateItem(String id, Map<String, dynamic> data) async {
    try {
      ...
      final jsPromise = js_util.callMethod(html.window, 'updateFirestoreItem', [
        id,
        jsData,
      ]);
  ...
  Future<bool> deleteItem(String id) async {
    try {
      ...
      final jsPromise = js_util.callMethod(html.window, 'deleteFirestoreItem', [
        id,
      ]);
